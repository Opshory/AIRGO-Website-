<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AirGo.Login" %>
    ...
    <div class="form-container">
        ...
        <form action="#" class="form-content">
            <fieldset>
                ...
                <asp:TextBox type="password" ID="TextBox2" runat="server" placeholder="Password" CssClass="form-input-control"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" Text="Login" style="height: 50px; width: 100%; " class="button" OnClick="Button1_Click"/>
        ...
        <div class="form-footer group">
            <p class="fl footer-text">
                ...
                <a style="color:white" href="Cacc.aspx">Create an account</a>
            </p>
